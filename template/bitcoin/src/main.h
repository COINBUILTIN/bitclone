...
static const int64 MIN_TX_FEE = ${bcl_min_tx_fee};
static const int64 MIN_RELAY_TX_FEE = ${bcl_min_tx_relay_fee};
static const int64 MAX_MONEY = ${bcl_max_money} * COIN; // maximum number of coins
